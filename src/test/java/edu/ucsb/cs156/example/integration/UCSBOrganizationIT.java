...
public class UCSBOrganizationIT {
    ...
    public void an_admin_user_can_post_a_new_org() throws Exception {
        ...
        UCSBOrganizations org1 = UCSBOrganizations.builder()
            .orgCode("csu")
            .orgTranslationShort("CSU")
            .orgTranslation("UCSB%20Chinese%20Student%20Union")
            .inactive(false)
            .build();

        // act
        MvcResult response = mockMvc.perform(
            post("/api/ucsborganizations/post?orgCode=csu&orgTranslationShort=CSU&orgTranslation=UCSB%20Chinese%20Student%20Union&inactive=false")
                .with(csrf()))
