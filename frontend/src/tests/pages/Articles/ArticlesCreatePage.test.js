...
describe("ArticlesCreatePage tests", () => {
  ...
  test("when you fill in the form and hit submit, it makes a request to the backend", async () => {
    ...
    axiosMock.onPost("/api/articles/post").reply(202, sbarticle);
    ...
    fireEvent.change(explanationField, { target: { value: "Groundhog Day" } });
    fireEvent.change(emailField, { target: { value: "Groundhog Day" } });
