...
describe("UCSBOrganizationIndexPage tests", () => {
  ...
  test("what happens when you click delete, admin", async () => {
    ...
    axiosMock
      ...
      .reply(200, ucsbOrganizationFixtures.threeOrgs);
    axiosMock
      .onDelete("/api/ucsborganizations", { params: { orgCode: "kasa" } })
      .reply(200, "UCSB Organization with orgCode kasa was deleted");
    ...
    await waitFor(() => {
      expect(mockToast).toHaveBeenCalledWith(
        "UCSB Organization with orgCode kasa was deleted",
      );
    });
  });
});