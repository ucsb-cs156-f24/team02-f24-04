...
describe("MenuItemReviewEditPage tests", () => {
  ...
  describe("tests where backend is working normally", () => {
    ...
    test("Is populated with the data provided", async () => {
      ...
      expect(itemIdField).toHaveValue(20221);
      ...
      expect(commentsField).toHaveValue("first text");
    ...
    test("Changes when you click Update", async () => {
      ...
      fireEvent.change(itemIdField, { target: { value: "20222" } });
      ...
      fireEvent.change(commentsField, { target: { value: "second text" } });

      fireEvent.click(submitButton);

      await waitFor(() => expect(mockToast).toBeCalled());
      expect(mockToast).toBeCalledWith(
        "MenuItemReview Updated - id: 17 itemId: 20222",
      );
